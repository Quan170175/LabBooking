    ...
    <Modal visible={visible} animationType="fade" transparent>
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <TextInput
            style={styles.input}
            placeholder="FPT Software, Đại học..."
            value={org}
            onChangeText={setOrg}
          />
...
export default function BookDevices() {
  ...
  const handleOpenEditGuest = (g: OutsideGuest) => {
    setGuestToEdit(g);
    setGuestModalOpen(true);
  };
  ...
  const handleOpenDeleteGuest = (id: string) => {
    setGuestToDeleteId(id);
  };
  ...
  const confirmBooking = async () => {
    ...
    if (maxCapacity > 0 && num > maxCapacity) {
      Alert.alert(
        "Quá tải",
        `Phòng này chỉ chứa tối đa ${maxCapacity} người.\nVui lòng giảm số lượng.`
      );
      return;
    }
    ...
    try {
      ...
      if (error.response?.data?.title)
        errorMsg = `Lỗi: ${error.response.data.title}`;
  ...
  const renderCommonFields = () => (
    <View style={styles.formSection}>
      ...
      />
      <Text style={styles.inputLabel}>
        Số lượng người tham gia <Text style={styles.required}>*</Text>
      </Text>
      <TextInput
        style={styles.input}
        placeholder="VD: 30"
      ...
      <View style={styles.switchRow}>
        ...
        <Switch
          value={isMajorOnly}
          onValueChange={setIsMajorOnly}
          trackColor={{ false: "#E2E8F0", true: "#FFEDD5" }}
          thumbColor={isMajorOnly ? "#EA580C" : "#94A3B8"}
        />
      </View>
      {!booking.type.includes("teaching") && (
        <View style={styles.switchRow}>
          ...
          <Switch
            ...
            trackColor={{ false: "#E2E8F0", true: "#FFEDD5" }}
            thumbColor={isPublic ? "#EA580C" : "#94A3B8"}
          />
        </View>
      )}
    </View>
  ...
  const renderTeachingFields = () => (
    <View style={styles.formSection}>
      ...
      >
        <Text
          style={[styles.dropdownText, !selectedCourse && { color: "#94A3B8" }]}
        >
          {selectedCourse
  ...
  const renderProjectFields = () => (
    <View style={styles.formSection}>
      ...
      <Text style={styles.inputLabel}>
        Tên dự án mới <Text style={styles.required}>*</Text>
      </Text>
      <TextInput
        style={styles.input}
    ...
    <View style={styles.formSection}>
      ...
      <View style={styles.warningBox}>
        <Text style={styles.warningText}>
          Lịch này sẽ được gửi đến Quản lý để xét duyệt ghi đè.
        </Text>
      </View>
      <Text style={styles.inputLabel}>
        Lý do ưu tiên <Text style={styles.required}>*</Text>
      </Text>
      <TextInput
        style={[styles.input, styles.textArea]}
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <BookingPageHeader
        ...
        subtitle={`Khai báo thông tin cho ${booking.roomName}`}
      />
              ...
              <BookingCard key={d.id} layout="default">
                <View style={styles.deviceInfoContainer}>
                  ...
                  <View style={styles.deviceTextWrapper}>
                    <Text style={styles.deviceName}>{d.equipmentName}</Text>
                    <Text style={styles.deviceDesc}>
                      {d.description || "Mặc định"} • {d.status}
                    </Text>
                  </View>
                </View>
              </BookingCard>
        ...
        <View style={styles.deviceList}>
          ...
          {guests.map((g) => (
            <BookingCard key={g.id} layout="default">
              <View style={styles.deviceInfoContainer}>
                <View
                  style={[styles.deviceIcon, { backgroundColor: "#FFEDD5" }]}
                >
                  <GuestIcon />
                </View>
                <View style={styles.deviceTextWrapper}>
              ...
              <View style={styles.cardActions}>
                ...
                <TouchableOpacity
                  onPress={() => handleOpenDeleteGuest(g.id)}
                  style={styles.cardButton}
                >
                  <Text style={[styles.cardButtonText, styles.deleteText]}>
                    Xóa
      ...
      <ConfirmationModal
        ...
        title="Xóa khách mời"
        message="Bạn có chắc muốn xóa khách mời này?"
        confirmText="Xóa"
        cancelText="Hủy"
