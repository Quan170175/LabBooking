...
export default function ManagerChangeCard({ request, onApprove, onReject }: Props) {
  ...
  return (
    <View style={[styles.card, isSystemOverride ? styles.overrideBorder : styles.changeBorder]}>
      ...
      <View style={styles.metaContainer}>
        ...
        <Text style={styles.metaInfo}>
           {createdDate} • Loại gốc: <Text style={{fontWeight:'600'}}>{request.originalType}</Text>
        </Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  roomName: { fontSize: 13, fontWeight: "700", color: "#475569", textTransform: "uppercase" },
  
  tagInfo: { backgroundColor: "#DBEAFE", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  tagInfoText: { fontSize: 10, color: "#1E40AF", fontWeight: "700" },
  
  tagWarn: { backgroundColor: "#FFEDD5", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  tagWarnText: { fontSize: 10, color: "#9A3412", fontWeight: "700" },

  title: { fontSize: 16, fontWeight: "700", color: "#0F172A", marginBottom: 6 },
  
  metaContainer: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 12 },
  metaInfo: { fontSize: 12, color: "#64748B" },

  slotContainer: { flexDirection: "row", gap: 8, backgroundColor: "white", padding: 10, borderRadius: 8, borderColor: "rgba(0,0,0,0.05)", borderWidth: 1 },
  slotText: { fontSize: 13, color: "#312E81", flex: 1, lineHeight: 18 },

  buttonContainer: { flexDirection: "row", gap: 12, marginTop: 16, paddingTop: 12, borderTopWidth: 1, borderTopColor: 'rgba(0,0,0,0.05)' },
  ...
  approveButton: { backgroundColor: "#F0FDF4", borderWidth: 1, borderColor: "#DCFCE7" },
