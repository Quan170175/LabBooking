...
export function LoginForm({ onSubmit, onRegisterPress, onForgotPasswordPress }: LoginFormProps) {
    ...
    return (
        <LinearGradient
            colors={["#FFE8C0", "#FF8C00"]} // nhạt → đậm để nhìn rõ hơn
            start={{ x: 0, y: 0 }}
            end={{ x: 0, y: 1 }}
            style={{ flex: 1 }}
        >
                ...
                <View style={[styles.container, { flex: 1 }]}>
                    ...
                    <View style={styles.logoSection}>
                        <View style={styles.logoContainer}>
                            <Ionicons name="person-circle" size={80} color={BrandColors.primaryDark} />
                        </View>
                    ...
                    <View style={styles.formSection}>
                        ...
                        <Text style={styles.termsText}>
                            Việc đăng nhập đồng nghĩa bạn đồng ý với Điều khoản sử dụng và Chính sách bảo mật của FPT University.
                        </Text>
                        <Text style={styles.footerText}>© 2025 FPT University · Lab Booking</Text>
                    </View>
                </View>
            </SafeAreaView>
        </LinearGradient>
...
const styles = StyleSheet.create({
    ...
    loginButton: {
        backgroundColor: '#FF7A05', // cam đậm hơn
        borderRadius: 30,
        paddingVertical: 18,
        alignItems: 'center',
        marginBottom: 24,
